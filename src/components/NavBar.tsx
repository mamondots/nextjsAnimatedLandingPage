...
const NavBar = () => {
  return (
    <div className="w-full max-w-screen-xl  mx-auto px-4 sm:px-8 lg:px-16 pt-10 pb-5 flex items-center justify-between font-light text-zinc-300 sticky top-0 backdrop-blur-md z-[999]">
      <div className="overflow-hidden">
        ...
        >
          <a href="/" className="z-50 flex items-center space-x-1">
            ...
            <span className="font-bold text-2xl text-white">Mamondots</span>
          </a>
        </motion.div>
      </div>
