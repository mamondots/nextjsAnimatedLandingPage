    ...
    <div className="relative pb-20">
      ...
      <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 pt-32">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-2xl sm:text-3xl lg:text-4xl text-white text-center mb-16 font-semibold"
        >
        ...
        <div>
          ...
          <div className="flex mt-8 sm:mt-0">
            ...
            <motion.div
              ...
              className="pt-8 sm:w-1/3 lg:w-1/5 hidden sm:flex flex-col items-center text-white"
            >
              <a
              ...
              <a
                className="inline-flex relative z-10 h-10 rounded-xl p-px shadow-lg button-hover bg-gradient-to-b from-white to-zinc-300 "
